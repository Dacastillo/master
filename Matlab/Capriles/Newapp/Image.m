...
function tiempo_integracion_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
    set(hObject,'Value','0');
end
...
% --- Executes on button press in GlobalStop.
function GlobalStop_Callback(hObject, eventdata, handles)
% hObject    handle to GlobalStop (see GCBO)
