...
efiex0= h5py.File('cav-ex-001600.00.h5','r')
defiex0=efiex0['ex']
efiex1= h5py.File('cav-ex-001700.00.h5','r')
defiex1=efiex1['ex']
efiex2= h5py.File('cav-ex-001800.00.h5','r')
defiex2=efiex2['ex']
hfiex0= h5py.File('cav-hx-001600.00.h5','r')
dhfiex0=hfiex0['hx']
hfiex1= h5py.File('cav-hx-001700.00.h5','r')
dhfiex1=hfiex1['hx']
hfiex2= h5py.File('cav-hx-001800.00.h5','r')
dhfiex2=hfiex2['hx']
efiey0= h5py.File('cav-ey-001600.00.h5','r')
defiey0=efiey0['ey']
efiey1= h5py.File('cav-ey-001700.00.h5','r')
defiey1=efiey1['ey']
efiey2= h5py.File('cav-ey-001800.00.h5','r')
defiey2=efiey2['ey']
hfiey0= h5py.File('cav-hy-001600.00.h5','r')
dhfiey0=hfiey0['hy']
hfiey1= h5py.File('cav-hy-001700.00.h5','r')
dhfiey1=hfiey1['hy']
hfiey2= h5py.File('cav-hy-001800.00.h5','r')
dhfiey2=hfiey2['hy']
efiez0= h5py.File('cav-ez-001600.00.h5','r')
defiez0=efiez0['ez']
efiez1= h5py.File('cav-ez-001700.00.h5','r')
defiez1=efiez1['ez']
efiez2= h5py.File('cav-ez-001800.00.h5','r')
defiez2=efiez2['ez']
hfiez0= h5py.File('cav-hz-001600.00.h5','r')
dhfiez0=hfiez0['hz']
hfiez1= h5py.File('cav-hz-001700.00.h5','r')
dhfiez1=hfiez1['hz']
hfiez2= h5py.File('cav-hz-001800.00.h5','r')
dhfiez2=hfiez2['hz']
