...
for i in range (0,100):
      ...
      disc_I1_S0S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])
