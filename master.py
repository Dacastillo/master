...
times = np.linspace(0,5,1000) #definir intervalo temporal 
...
def me3(IN,RES):
    ...
    out=[[0 for i in range(1000)],[0 for i in range(1000)]]
    conc=[0 for i in range(1000)]
    disc=[0 for i in range(1000)]    
    def entropy_opt(a):
...
tiempo = [(1/200)*i for i in range(1000)]#Intervalo de tiempo para los gráficos
