...
for i in range (0,100):
      ...
      disc_I1_S0S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
      ...
      disc_I2_S0S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
      ...
      disc_I3_S0S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
      ...
      disc_I4_S0S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
      ...
      disc_I5_S0S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
      ...
      disc_I1_S1S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I2_S1S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I3_S1S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I4_S1S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I5_S1S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I1_S2S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I2_S2S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I3_S2S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I4_S2S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I5_S2S[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I1_S0C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I2_S0C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I3_S0C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I4_S0C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I5_S0C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I1_S1C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I2_S1C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I3_S1C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I4_S1C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I5_S1C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I1_S2C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I2_S2C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
for i in range (0,100):
    ...
    disc_I3_S2C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
...
for i in range (0,100):
    ...
    disc_I4_S2C[i]=mat.eigenenergies()[0]*np.log(4*mat.eigenenergies()[0])+mat.eigenenergies()[1]*np.log(4*mat.eigenenergies()[1])+mat.eigenenergies()[2]*np.log(4*mat.eigenenergies()[2])+mat.eigenenergies()[3]*np.log(4*mat.eigenenergies()[3])+0.5*(-(1+c)*np.log2(np.absolute(1+c))-(1-c)*np.log2(np.absolute(1-c)))
